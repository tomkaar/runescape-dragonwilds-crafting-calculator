...
export default function TableBodyRow(props: Props) {
  ...
  return (
    <tr
      ...
      key={row.id}
      className={`flex absolute w-full border-b border-neutral-800 hover:bg-neutral-800/50 cursor-pointer transition-colors ${virtualRow.index % 2 === 0 ? "bg-background" : "bg-card/50"}`}
